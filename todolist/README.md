...
Now you can rename `src/Todolist.css` to `src/Todolist.scss` and update `src/Todolistolist.js` to import `src/Todolist.scss`.
...
Import required reactstrap components within `src/Todolist.jsst.js` file or your custom component files:
...
| INLINE_RUNTIME_CHUNK |          :x:           | :white_check_mark: | By default, Create React Todolist will embed the runtime script into `index.html` during the production build. When set to `false`, the script will not be embedded and will be imported as usual. This is normally required when dealing with CSP.                                                                                                                                                                                                                                                                                                                                                                                                                       |
